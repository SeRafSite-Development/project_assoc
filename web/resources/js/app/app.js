define(["require", "exports", "jquery", "./models/books"], function (require, exports, $, books) {
    "use strict";
    var App = (function () {
        function App() {
        ...
        App.prototype.drawView = function (filtered) {
            ...
            listContainer.empty();
            listContainer.append('<table class="table table-hover" border="1"><tr><th>ID</th><th>Name</th><th>Description</th><th>Author</th></tr></table>');
            var html = '';
